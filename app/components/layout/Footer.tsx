    ...
    <footer className="bg-[#2C2B2B] text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-[#E6DEDE] leading-relaxed">
              ...
              estratégicos que ayudan a las empresas a comunicar su valor y
          ...
          <div>
            ...
            <div className="space-y-3 text-[#E6DEDE]">
              <p>bedigitallight@gmail.com</p>
              <p>+57 322 858 8926</p>

              {/* REDES */}
              <div className="flex gap-5 mt-4">
                <Link
                  href="https://www.instagram.com/bedigitallight/"
                  target="_blank"
                ...
                <Link
                  href="https://wa.me/573228588926?text=Hola%20quiero%20información%20sobre%20desarrollo%20web"
                  target="_blank"
                  className="text-[#E6DEDE] hover:text-[#F3EEE9] transition"
                >
        ...
        <div className="border-t border-[#6B6B6B] mt-12 pt-6 text-center text-sm text-[#E6DEDE]">
          © {new Date().getFullYear()} BDL Agency. Todos los derechos
          reservados.
        </div>
      </div>
    </footer>
